...
SecDecPrepareSum["/users/tp/jasons/Documents/Scripts/ggH_1L_alib", basesWithoutMt2, fullAmplitudeByPrefactor//KeyMap[InputForm/*ToString]//Map[ReplaceAll[d->4-2*eps]],Order->0];
Print["--- Done ---"];
